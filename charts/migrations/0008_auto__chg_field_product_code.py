...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('charts_product', 'code', self.gf('django.db.models.fields.CharField')(max_length=13))

    def backwards(self, orm):

        # Changing field 'Product.code'
        db.alter_column('charts_product', 'code', self.gf('django.db.models.fields.CharField')(max_length=10))
