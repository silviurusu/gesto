...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('charts_location', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Location.name'
        db.alter_column('charts_location', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
