...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.dep'
        db.delete_column('charts_product', 'dep_id')

        # Adding field 'Product.category'
        db.add_column('charts_product', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['charts.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.dep'
        db.add_column('charts_product', 'dep',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['charts.Category']),
                      keep_default=False)

        # Deleting field 'Product.category'
        db.delete_column('charts_product', 'category_id')
    ...
    models = {
        ...
        'charts.category': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'categories'", 'to': "orm['charts.Company']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'charts.company': {
        ...
        'charts.product': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['charts.Category']"}),
