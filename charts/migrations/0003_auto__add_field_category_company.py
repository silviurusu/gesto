...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('charts_category', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='categories', to=orm['charts.Company']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.company'
        db.delete_column('charts_category', 'company_id')
